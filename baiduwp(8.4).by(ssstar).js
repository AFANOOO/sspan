                                            ...
                                            GM_xmlhttpRequest({
                                                ...
                                                onload: function (ress) {
                                                    ...
                                                    if (ress.response.error == 0) {
                                                        ...
                                                        Swal.fire('解析成功', 'IDM下载务必设置好(UA) ->填入->LogStatistic否则下载报错403，推送Aria2/Motrix时需要提前启动软件检查RPC地址是否正确，推送失败尝试取消Token！关闭代理工具！<br><a  href="https://ass.coxpan.com" target="_blank"style=" font-weight: 900;">作者推荐:超低价百度网盘svip出租，稳定好用！</a><br><a href="https://t.me/+B1PiSmBGPIw0MTYx" target="_blank"style=" font-weight: 900;">点击加入防失联交流群组</a>', 'success');
