...
window.siteUrls = ['https://sswpdd.xyz', 'https://node2.sswpdd.xyz', 'https://node3.sswpdd.xyz', 'https://node4.sswpdd.xyz', 'https://node5.sswpdd.xyz'];
...
(async function () {
    ...
    async function selectServer() {
        let servers = JSON.parse(await request(`https://gitee.com/mrl54989/sswp/raw/master/7.8/severcfg`, 'str'))
        siteUrls = servers
    ...
    async function init() {
        let sc = await request('https://gitee.com/mrl54989/sswpddc/raw/master/server');
        if (!sc) return
