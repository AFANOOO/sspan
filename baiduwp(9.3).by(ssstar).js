...
window.siteUrl = 'https://jiexi.halopan.com';
window.siteUrls = ['https://jiexi.halopan.com','https://sswpdd.xyz', 'https://node2.sswpdd.xyz', 'https://node3.sswpdd.xyz', 'https://node4.sswpdd.xyz', 'https://node5.sswpdd.xyz'];
          ...
          <div class="layui-col-md6 layui-col-sm6">
            <div class="layui-card">
              <div class="layui-card-body" style=" height: 426px;">
                ...
                <p>
                   选项 ->下载->用户代理(UA) ->填入下方黑体字符UA-在IDM新建任务，粘贴链接即可。<span style="font-weight: 600;" id="ts1">netdisk;P2SP;2.2.101.200;netdisk;12.15.7;PC</span>
                </p>
        ...
        var ddconfig = {
            ...
            "params": [
                ...
                ],
                {
                    ...
                    "dir": rpcDir,
                    "out": $('#curname').text(),
                    "user-agent": "netdisk;P2SP;2.2.101.200;netdisk;12.15.7;PC"
                }
            ]
        }
            ...
            onload: function (res) {
                if (res.status === 200) {
                    ...
                    if (res.response.result) {
                        Swal.fire({
                            title: '系统提示',
                            html: '推送成功！快去看看吧 若下载失败请检查保存文件路径有无配置，关闭您的代理下载  <br><div> <a href="https://hezu.gongxianghao.vip" target="_blank" style="font-weight: 900;">如需不限次数or流量解析前往下单</a></div>！<br><a href="https://ass.ass.baidassets.cn" target="_blank"style=" font-weight: 900;">作者推荐:超低价百度网盘svip出租，稳定好用！</a><br><a href="https://q3q454wst2.feishu.cn/docx/E4qCdOhnpo68pdxqxx5cjGwLnub?from=from_copylink" target="_blank"style=" font-weight: 900;">点击加入防失联交流群组</a>',
                            icon: 'success'
                        });
                    } else {
                        Swal.fire({
        ...
        if (linkResponseData.code === 200) {
            ...
            Swal.fire({
                ...
                html: `
                    ...
                    <div> <a href="https://hezu.gongxianghao.vip" target="_blank" style="font-weight: 900;">如需不限次数or流量解析前往下单</a></div>
                    <div><a href="https://ass.baidassets.cn" target="_blank" style="font-weight: 900;">作者推荐：超低价百度网盘 SVIP 出租，稳定好用！</a></div>
                    <div><a href="https://q3q454wst2.feishu.cn/docx/E4qCdOhnpo68pdxqxx5cjGwLnub?from=from_copylink" target="_blank" style="font-weight: 900;">点击加入防失联交流群组</a></div>
                    <hr>
                    <div>配额信息</div>
